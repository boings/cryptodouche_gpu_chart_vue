...
```sh
pnpm add 'git+https://github.com/boings/cryptodouche_gpu_chart_vue.git#v0.1.12'
```

SSH works too:

```sh
pnpm add 'git+ssh://git@github.com/boings/cryptodouche_gpu_chart_vue.git#v0.1.12'
```
